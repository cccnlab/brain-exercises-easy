                    ...
                    <div className={'instructionContainer' + (tutorialStep === 15 ? ' centered': '')}>
                        ...
                        <div className="instructionBox">
                            <div className= "instructionText">
                                ...
                                {tutorialStep === 4 ? <p>หากมีให้กดปุ่ม “<b style={{ color : `#26A445`}}>มี</b>”  <br></br>หากไม่มีกดปุ่ม “<b style={{ color : `#E52D27`}}>ไม่มี</b>” <br></br> <i style={{ color : `#808080`}}>กดปุ่ม "ถััดไป" ด้่่านล่างเพื่อไปต่อ </i></p> : null}
